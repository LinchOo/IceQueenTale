...
class DataController: ObservableObject {
    ...
    let Titles: [String] = ["Ice Mountain", "Cold Water", "Frozen Tree", "Broken Bridge", "Fallen Tree", "Hills", "Frozen River", "Frozen Lake", "Queen Castle", "Forest and River", "Clear Sky", "Cold Snow", "Frozen Wind", "Through the Forest", "Wolf", "Snow Glade", "Forest Night", "Unexpected Guest"]
